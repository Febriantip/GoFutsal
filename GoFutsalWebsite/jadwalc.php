...
.book, .back{
  ...
  <table class="table table-light table-striped">
    ...
    <tbody>
                    ...
                    require 'koneksi.php';
                    $jadwalc = query("SELECT * FROM jadwalc");

                    ?>

                    <?php $i = 1; ?>
                    <?php foreach ( $jadwalc as $row ): ?>
            ...
            <div class="d-grid">
  <button type="button" class="btn btn-light btn-block"><a href="bookc.php" class="book">Book Your Team Here!</button>
</div> 
