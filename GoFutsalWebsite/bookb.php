...
<body> 
  ...
  <div class="form-group">
    ...
    <br>
  <button type="bookb" name="bookb" class="btn btn-primary">Book</button>
</form>
<div class="mb-3 mt-3">
<div class="row1">
    <div class="col1">
        <button type="button" class="btn btn-light"><a href="jadwalb.php" class="back">Back</a></button></button>
    </div>
</div>
</div>
            </div>
