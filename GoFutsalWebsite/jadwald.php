...
.book, .back{
  ...
  <table class="table table-light table-striped">
    ...
    <tbody>
                    ...
                    require 'koneksi.php';
                    $jadwald = query("SELECT * FROM jadwald");

                    ?>

                    <?php $i = 1; ?>
                    <?php foreach ( $jadwald as $row ): ?>
            ...
            <div class="d-grid">
              <button type="button" class="btn btn-light btn-block"><a href="bookd.php" class="book">Book Your Team Here!</button>
            </div> 
